...
#get_ipython().system(u'wget https://storage.googleapis.com/mledu-datasets/mnist_train_small.csv -O /tmp/mnist_train_small.csv')
...
def get_classifier(model_dir):
  estimator_from_file = make_estimator(model_dir, [100, 100], 0.05)
  return estimator_from_file

def predict_class(tt, te, classifier):
  predict_test_input_fn = create_predict_input_fn(
      te, tt, batch_size=1)

  predictions = classifier.predict(input_fn=predict_test_input_fn)
